...
{
    /// <summary>
    /// Preload dialog ViewModel - drives the preload dialog UI and actions.
    /// </summary>
    public partial class PreloadMidiViewModel : ObservableObject
    {
        public event Action<PreloadDialogResult>? RequestClose;
        /// <summary>
        /// 当用户点击“加载”但对话框不应立即关闭时触发（用于在对话框内部开始进度任务）
        /// </summary>
    ...
    private bool _isStarting = false;
        ...
        public PreloadMidiViewModel(string fileName, long fileSizeBytes)
        {
            _fileName = fileName;
        ...
        {
            RequestClose?.Invoke(PreloadDialogResult.Reselect);
        }
