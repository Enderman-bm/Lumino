...
namespace DominoNext.Models.Settings
{
    ...
    public partial class SettingsModel : ObservableObject
    {
        ...
        [ObservableProperty]
        private string _selectedPlaybackDeviceId = "-1"; // 使用字符串ID而不是复杂对象

        [ObservableProperty]
        private string _selectedPlaybackDeviceName = "默认设备";

        [ObservableProperty]
        private string _playlistSettingsJson = "[]"; // 播放列表设置JSON

        [ObservableProperty]
        private string _playbackDevicesJson = "[]"; // 播放设备设置JSON
        ...
        public void ResetToDefaults()
        {
            ...
            SelectedPlaybackDeviceName = "默认设备";
