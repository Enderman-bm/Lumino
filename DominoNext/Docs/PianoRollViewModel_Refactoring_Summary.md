...
**文件位置**: `DominoNext\ViewModels\Editor\Components\PianoRollConfiguration.cs`
...
**文件位置**: `DominoNext\ViewModels\Editor\Components\PianoRollViewport.cs`
...
**文件位置**: `DominoNext\ViewModels\Editor\Components\PianoRollCalculations.cs`
...
**文件位置**: `DominoNext\ViewModels\Editor\Components\PianoRollCoordinates.cs`
...
**文件位置**: `DominoNext\ViewModels\Editor\Components\PianoRollCommands.cs`
