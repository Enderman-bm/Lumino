...
### MouseCurveRenderer
位置: `DominoNext/Views/Rendering/Common/MouseCurveRenderer.cs`
...
### 新增文件
- `DominoNext/Views/Rendering/Common/MouseCurveRenderer.cs` - 通用鼠标曲线渲染器
- `DominoNext/Views/Rendering/Events/PitchCurveRenderer.cs` - 音高编辑示例 (演示用途)

### 修改文件
- `DominoNext/Views/Rendering/Events/VelocityBarRenderer.cs` - 移除曲线绘制逻辑，使用新的渲染器
