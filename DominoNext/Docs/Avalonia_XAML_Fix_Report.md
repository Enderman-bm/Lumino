...
HResult=0x80131500
Message=No precompiled XAML found for DominoNext.App, make sure to specify x:Class and include your XAML file as AvaloniaResource
```
...
<Window xmlns="https://github.com/avaloniaui"
        ...
        x:Class="DominoNext.Views.Dialogs.ConfirmationDialog"
        <!-- 缺少 x:DataType 指令 -->
        ...>
...
<Window xmlns="https://github.com/avaloniaui"
        ...
        xmlns:local="using:DominoNext.Views.Dialogs"
        ...>
...
**修复后：**
```
DominoNext 成功，出现 4 警告 (4.2 秒) → bin\Debug\net8.0\DominoNext.dll
```
...
### 项目文件参考
- `DominoNext/Views/Dialogs/ConfirmationDialog.axaml` - 修复后的对话框模板
- `DominoNext/App.axaml` - 完整的应用程序资源配置
- `DominoNext/Converters/SettingsConverters.cs` - 转换器实现
